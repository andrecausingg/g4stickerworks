...
<body>
    ...
    <div class="g-main-container yot-vh-100 yot-w-100 yot-content-space-margin-t-80 yot-content-space-margin-t-80-remove" style="padding: 0;">
        ...
        <div class="g-main-item-right" style="padding: 24px; position: relative;">
            ...
            <!-- Table -->
            <div class="yot-w-100" id="displayOrderTemporaryPlate" style="max-height:650px; overflow-y:scroll"></div>
        </div>
    </div>
    ...
    <script src="./asset/js/orders-temporary-plate/display/d-order-temporary-plate.js"></script>
    <script src="./asset/js/orders-temporary-plate/update.js"></script>
    <script src="./asset/js/orders-temporary-plate/display/d-search-start-date-end-date.js"></script>
</body>
</html>