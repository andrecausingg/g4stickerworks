            ...
            <div class="yot-hide-for-mobile yot-flex">
                ...
                <div style="position: relative">
                    ...
                    <div class="rPmLContainer yot-ml-48 yot-flex yot-flex-fd-c yot-bg-white yot-pa-16" style="display:none; position: absolute; width: 200px; right: -111px;">
                        ...
                        <a href="sticker-label" class="yot-text-fs-xl yot-mb-8 yot-active-bb-blue">Sticker Labels</a>
    ...
    <div class="yot-content-space-margin-t-120 yot-container">
        ...
        <section>
            ...
            <div class="yot-flex yot-flex-ai-c-jc-c yot-mb-16">
                <h1 id="decalsTitle" class="yot-resize-font-64 yot-tc-blue1">Sticker Label</h1>
            </div>

            <!-- All Temporary Plate -->
            <section id="stickerLabelDisplay"></section>
        </section>
    </div>
