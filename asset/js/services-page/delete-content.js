$(document).ready(function(){
    // Delete All
    $(document).on("click", ".deleteIconContent", function() {
        const id = $(this).attr("data-id");
        
        if(id != ""){
            $.ajax({
                type: "POST",
                url: "../../../../g4stickerworks/asset/php/services-page/delete-sub-title.php", // replace with the URL of your form processing script
                data: { 
                    id: id
                },
