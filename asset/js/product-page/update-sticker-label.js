$(document).ready(function(){
    $(document).on("click", ".updateIconImageStickerLabel", function() {
        const id = $(this).attr("data-id").trim();
        const fileInput = $('#imageUpdateStickerLabel[data-id="' + id + '"]');
        ...
        if(id != ""){
            ...
            $.ajax({
                url: '../../../../g4stickerworks/asset/php/product-page/update-sticker-label.php', // replace this with your server URL
                type: 'POST',
