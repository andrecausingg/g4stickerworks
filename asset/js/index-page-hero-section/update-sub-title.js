$(document).ready(function(){
    // Update
    $(document).on("click", ".updateIconSubTitle", function() {
        ...
        if(id != "" && subTitle != ""){
            ...
            $.ajax({
                ...
                url: "../../../../g4stickerworks/asset/php/index-page-hero-section/update-sub-title.php", // replace with the URL of your form processing script
                data: { 
                    id:id,
                    subTitle: subTitle,
