                ...
                echo'
                    <tr>
                        <td class="pp-table-images yot-flex yot-flex-fd-c-ai-c">
                            ...
                            <input class="yot-form-input" type="file" name="imageTempPlateUpdate" id="imageTempPlateUpdate" data-id="'. htmlspecialchars($row["temp_plate_id"]).'">
                        </td>
                        <td>'.htmlspecialchars($row["type"]).'</td>
                        <td>'.htmlspecialchars($row["created_at_varchar"]).'</td>
                        <td><button class="yot-btn-blue1 updateIconTempPlate" data-id="'. htmlspecialchars($row["temp_plate_id"]).'">Update</button></td>
                    </tr>
                ';
            }
