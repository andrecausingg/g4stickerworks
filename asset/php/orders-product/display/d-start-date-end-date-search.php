...
class ClassSearch{
    ...
    public function getSearch(){
        ...
        $query .= " ORDER BY order_product_id DESC";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '
                    <tr>
                        ...
                        <td>
                        ';
                            $this->getSelectTagStatusOrder($row["status_order"], $row["order_product_id"], $userId);
                        echo'
                        </td>
                    </tr>
                ';
