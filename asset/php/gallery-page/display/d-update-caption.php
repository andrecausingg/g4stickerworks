        ...
        public function getDataCaption(){
            ...
            while($row = $result->fetch_assoc()){
                echo'
                    <tr>
                        <td>
                            <textarea class="yot-form-input yot-tff-sas" data-id="'. htmlspecialchars($row["gallery_page_id"]).' type="text" name="updateCaption" id="updateCaption" style="height:80px;resize:none;" >'.htmlspecialchars($row["caption"]).'</textarea>
                        </td>
                        <td>
