...
<body>
    ...
    <div class="yot-content-space-margin-t-120 yot-container yot-overlay-mid-container-form-tablet-size-up">
        <!-- Temporary Plate -->
        <div id="signUpContainer" class="yot-overlay-mid-container" >
            <div class="yot-overlay-mid-child yot-bg-white yot-pa-16 yot-overlay-mid-container-form">
                <form id="signUpForm">
                    ...
                    <div>
                        <img style="display:" src="./asset/images/temp-plate-format-1.png" alt="">
                        <img style="display:none" src="./asset/images/temp-plate-format-2.png" alt="">
                        <img style="display:none" src="./asset/images/temp-plate-format-3.png" alt="">
                        <img style="display:none" src="./asset/images/temp-plate-format-4.png" alt="">
                    </div>
